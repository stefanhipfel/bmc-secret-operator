...
*/}}
{{- define "bmc-secret-operator.name" -}}
...
*/}}
{{- define "bmc-secret-operator.fullname" -}}
...
*/}}
{{- define "bmc-secret-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "bmc-secret-operator.resourceName" -}}
{{- $fullname := include "bmc-secret-operator.fullname" .context }}
{{- $suffix := .suffix }}
